...
class Reference {
  ...
  int get length {
    ...
    if (ValueTypeUtils.isFixedTypedVector(_valueType)) {
      ...
      var size = _readUInt(indirect - sizeByteWidth, BitWidthUtil.fromByteWidth(sizeByteWidth));
      while (_buffer.getInt8(indirect + size) != 0) {
        sizeByteWidth <<= 1;
        size = _readUInt(indirect - sizeByteWidth, BitWidthUtil.fromByteWidth(sizeByteWidth));
      }
      _length = size;
