...
class StackTraceDetailPage extends StatelessWidget {
  ...
  StackTraceDetailPage(
      {required this.stackTrace, this.name, this.errorJson, this.error});
