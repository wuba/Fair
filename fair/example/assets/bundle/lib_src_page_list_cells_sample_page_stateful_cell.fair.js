GLOBAL['#FairKey#'] = (function(__initProps__) {
    ...
    function(__mod__) {
        ...
        __mod__.exports.LouPanDetail = LouPanDetail;
        __mod__.exports.GoodsDesc = GoodsDesc;
    },
    []);
    return runCallback(function(__mod__) {
        with(__mod__.imports) {
            ...
            _State.__inner__ = function inner() {
                this._fairProps = __initProps__;
                                        console.log('_fairProps = ' + JSON.stringify(__initProps__));
                this._louPanDetail = null;
            };
            _State.prototype = {
                ...
                onLoad: function onLoad() {
                    ...
                    with(__thiz__) {
                        _louPanDetail = _fairProps.__op_idx__('louPanDetail');
                                                console.log('_louPanDetail.imgUrl222 = ' + _louPanDetail.imgUrl);
                    }
                },
