...
var p = () =>
{
  ...
  'ScrollDragController': {
    'momentumRetainStationaryDurationThreshold': ScrollDragController.momentumRetainStationaryDurationThreshold,
    'motionStoppedDurationThreshold': ScrollDragController.motionStoppedDurationThreshold,
  },
  'AutofillGroup': (props) =>
      AutofillGroup(
        key: props['key'],
  ...
  'AnimatedList.of': (props) =>
      AnimatedList.of(
        props['pa'][0],
      ),
  'AnimatedList.maybeOf': (props) =>
  ...
  'DragTarget#onLeave': (props) =>
      (Object data,) {
    return (props['block']);
  },
  'DragTarget#onMove': (props) =>
      (DragTargetDetails details,) {
    return (props['block']);
  },
  'DragAnchor': {
  ...
  'Table': (props) =>
      Table(
        ...
        defaultColumnWidth: props['defaultColumnWidth'] ?? const FlexColumnWidth(1.0),
        textDirection: props['textDirection'],
        border: props['border'],
  ...
  'Scrollable.ensureVisible': (props) =>
  ...
  'EditableText': (props) =>
      EditableText(
        ...
        toolbarOptions: props['toolbarOptions'] ?? const ToolbarOptions(copy: true, cut: true, paste: true, selectAll: true),
  ...
  'Navigator.restorableReplace': (props) =>
  ...
  'Directionality.of': (props) =>
      Directionality.of(
        props['pa'][0],
      ),
  'Directionality.maybeOf': (props) =>
  ...
  'ReorderableList.of': (props) =>
      ReorderableList.of(
        props['pa'][0],
      ),
  'ReorderableList.maybeOf': (props) =>
      ReorderableList.maybeOf(
        props['pa'][0],
      ),
  'SliverReorderableList': (props) =>
  ...
  'ReorderableDragStartListener': (props) =>
  ...
  'BouncingScrollSimulation': {
    'maxSpringTransferVelocity': BouncingScrollSimulation.maxSpringTransferVelocity,
  },
  'Overlay': (props) =>
      Overlay(
        key: props['key'],
