...
var p = () =>
{
  'AnimatedCrossFade': (props) => AnimatedCrossFade(key: props['key'],
  ...
  'SingleChildScrollView': (props) => SingleChildScrollView(key: props['key'],
  ...
  'AnimatedSize': (props) => AnimatedSize(key: props['key'],
    child: props['child'],
    ...
    vsync: props['vsync'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'SliverFillViewport': (props) => SliverFillViewport(key: props['key'],
    delegate: props['delegate'],
    viewportFraction: props['viewportFraction']?.toDouble() ?? 1.0,
    padEnds: props['padEnds'] ?? true,),
  'SliverFillRemaining': (props) => SliverFillRemaining(key: props['key'],
    child: props['child'],
  ...
  'Localizations': (props) => Localizations(key: props['key'],
    locale: props['locale'],
    delegates: (props['delegates']),
    child: props['child'],),
  'Localizations.override': (props) => Localizations.override(key: props['key'],
  ...
  'CustomScrollView': (props) => CustomScrollView(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    primary: props['primary'],
    ...
    restorationId: props['restorationId'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'ListView': (props) => ListView(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    primary: props['primary'],
  ...
  'ListView.builder': (props) =>
      ListView.builder(key: props['key'],
        scrollDirection: props['scrollDirection'] ?? Axis.vertical,
        reverse: props['reverse'] ?? false,
        controller: props['controller'],
        primary: props['primary'],
        ...
        restorationId: props['restorationId'],
        clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'ListView.separated': (props) => ListView.separated(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    primary: props['primary'],
    ...
    restorationId: props['restorationId'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'ListView.custom': (props) => ListView.custom(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    primary: props['primary'],
    ...
    restorationId: props['restorationId'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'GridView': (props) => GridView(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    primary: props['primary'],
    ...
    keyboardDismissBehavior: props['keyboardDismissBehavior'] ??
        ScrollViewKeyboardDismissBehavior.manual,
    restorationId: props['restorationId'],),
  'GridView.builder': (props) => GridView.builder(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    primary: props['primary'],
    ...
    restorationId: props['restorationId'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'GridView.custom': (props) => GridView.custom(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    primary: props['primary'],
  ...
  'RawKeyboardListener': (props) => RawKeyboardListener(key: props['key'],
  ...
  'Overlay': (props) => Overlay(key: props['key'],
    initialEntries: props['initialEntries'] ?? const <OverlayEntry>[],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'Overlay.of': (props) => Overlay.of(
    props['pa'][0], rootOverlay: props['rootOverlay'] ?? false,
    debugRequiredFor: props['debugRequiredFor'],),
  'RawAutocomplete': (props) => RawAutocomplete(key: props['key'],
  ...
  'WidgetsApp': (props) =>
      WidgetsApp(key: props['key'],
        ...
        navigatorObservers: props['navigatorObservers'] ??
  ...
  'WidgetsApp.router': (props) =>
      WidgetsApp.router(key: props['key'],
        ...
        restorationScopeId: props['restorationScopeId'],
        useInheritedMediaQuery: props['useInheritedMediaQuery'] ?? false,),
  'AndroidView': (props) => AndroidView(key: props['key'],
    ...
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'UiKitView': (props) => UiKitView(key: props['key'],
    viewType: props['viewType'],
    onPlatformViewCreated: props['onPlatformViewCreated'],
    hitTestBehavior: props['hitTestBehavior'] ??
        PlatformViewHitTestBehavior.opaque,
    ...
    creationParamsCodec: props['creationParamsCodec'],
    gestureRecognizers: props['gestureRecognizers'],),
  'HtmlElementView': (props) => HtmlElementView(key: props['key'],
    viewType: props['viewType'],
    onPlatformViewCreated: props['onPlatformViewCreated'],),
  'PlatformViewLink': (props) => PlatformViewLink(key: props['key'],
    surfaceFactory: props['surfaceFactory'],
    onCreatePlatformView: props['onCreatePlatformView'],
    viewType: props['viewType'],),
  'PlatformViewSurface': (props) => PlatformViewSurface(key: props['key'],
    controller: props['controller'],
    hitTestBehavior: props['hitTestBehavior'],
    gestureRecognizers: props['gestureRecognizers'],),
  'AndroidViewSurface': (props) => AndroidViewSurface(key: props['key'],
    controller: props['controller'],
    hitTestBehavior: props['hitTestBehavior'],
    gestureRecognizers: props['gestureRecognizers'],),
  'RawScrollbar': (props) =>
      RawScrollbar(key: props['key'],
        child: props['child'],
        controller: props['controller'],
        ...
        minThumbLength: props['minThumbLength']?.toDouble() ?? 18.0,
        ...
        fadeDuration: props['fadeDuration'] ?? const Duration(milliseconds: 300),
        timeToFade: props['timeToFade'] ?? const Duration(milliseconds: 600),
  ...
  'SafeArea': (props) => SafeArea(key: props['key'],
    ...
    child: props['child'],),
  'SliverSafeArea': (props) => SliverSafeArea(key: props['key'],
    left: props['left'] ?? true,
    top: props['top'] ?? true,
    right: props['right'] ?? true,
    bottom: props['bottom'] ?? true,
    minimum: props['minimum'] ?? EdgeInsets.zero,
    sliver: props['sliver'],),
  'WillPopScope': (props) => WillPopScope(key: props['key'],
    child: props['child'],
    onWillPop: props['onWillPop'],),
  'Dismissible': (props) => Dismissible(key: props['key'],
    child: props['child'],
  ...
  'PlatformMenuBar': (props) => PlatformMenuBar(
    key: props['key'], body: props['body'], menus: (props['menus']),),
  ...
  'SliverFixedExtentList': (props) => SliverFixedExtentList(key: props['key'],
    delegate: props['delegate'],
    itemExtent: props['itemExtent']?.toDouble(),),
  'SliverGrid': (props) => SliverGrid(key: props['key'],
    delegate: props['delegate'],
    gridDelegate: props['gridDelegate'],),
  'SliverGrid.count': (props) => SliverGrid.count(key: props['key'],
    crossAxisCount: props['crossAxisCount'],
    mainAxisSpacing: props['mainAxisSpacing']?.toDouble() ?? 0.0,
    crossAxisSpacing: props['crossAxisSpacing']?.toDouble() ?? 0.0,
    childAspectRatio: props['childAspectRatio']?.toDouble() ?? 1.0,
    children: props['children'] ?? const <Widget>[],),
  'SliverGrid.extent': (props) => SliverGrid.extent(key: props['key'],
    maxCrossAxisExtent: props['maxCrossAxisExtent']?.toDouble(),
    mainAxisSpacing: props['mainAxisSpacing']?.toDouble() ?? 0.0,
    crossAxisSpacing: props['crossAxisSpacing']?.toDouble() ?? 0.0,
    childAspectRatio: props['childAspectRatio']?.toDouble() ?? 1.0,
    children: props['children'] ?? const <Widget>[],),
  'SliverOpacity': (props) => SliverOpacity(key: props['key'],
    opacity: props['opacity']?.toDouble(),
    alwaysIncludeSemantics: props['alwaysIncludeSemantics'] ?? false,
    sliver: props['sliver'],),
  'SliverIgnorePointer': (props) => SliverIgnorePointer(key: props['key'],
    ignoring: props['ignoring'] ?? true,
    ignoringSemantics: props['ignoringSemantics'],
    sliver: props['sliver'],),
  'SliverOffstage': (props) => SliverOffstage(key: props['key'],
    offstage: props['offstage'] ?? true,
    sliver: props['sliver'],),
  'KeepAlive': (props) => KeepAlive(key: props['key'],
    keepAlive: props['keepAlive'],
    child: props['child'],),
  'ListWheelScrollView': (props) => ListWheelScrollView(key: props['key'],
    controller: props['controller'],
    physics: props['physics'],
    ...
    overAndUnderCenterOpacity: props['overAndUnderCenterOpacity']?.toDouble() ??
        1.0,
    itemExtent: props['itemExtent']?.toDouble(),
    squeeze: props['squeeze']?.toDouble() ?? 1.0,
    onSelectedItemChanged: props['onSelectedItemChanged'],
    renderChildrenOutsideViewport: props['renderChildrenOutsideViewport'] ??
        false,
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,
    restorationId: props['restorationId'],
    scrollBehavior: props['scrollBehavior'],
  ...
  'ListWheelViewport': (props) => ListWheelViewport(key: props['key'],
    diameterRatio: props['diameterRatio']?.toDouble() ??
        RenderListWheelViewport.defaultDiameterRatio,
    perspective: props['perspective']?.toDouble() ??
        RenderListWheelViewport.defaultPerspective,
  ...
  'ScrollDragController': {
    'momentumRetainStationaryDurationThreshold': ScrollDragController
        .momentumRetainStationaryDurationThreshold,
    'momentumRetainVelocityThresholdFactor': ScrollDragController
        .momentumRetainVelocityThresholdFactor,
    'motionStoppedDurationThreshold': ScrollDragController
        .motionStoppedDurationThreshold,
  },
  'AutofillGroup': (props) => AutofillGroup(key: props['key'],
    child: props['child'],
  ...
  'InteractiveViewer': (props) => InteractiveViewer(key: props['key'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,
  ...
  'Focus.withExternalFocusNode': (props) => Focus.withExternalFocusNode(
    ...
    includeSemantics: props['includeSemantics'] ?? true,),
  'Focus.of': (props) =>
      Focus.of(props['pa'][0], scopeOk: props['scopeOk'] ?? false,),
  'Focus.maybeOf': (props) =>
      Focus.maybeOf(props['pa'][0], scopeOk: props['scopeOk'] ?? false,),
  'Focus.isAt': (props) => Focus.isAt(props['pa'][0],),
  'FocusScope': (props) => FocusScope(key: props['key'],
    node: props['node'],
    child: props['child'],
    autofocus: props['autofocus'] ?? false,
    onFocusChange: props['onFocusChange'],
  ...
  'FocusScope.withExternalFocusNode': (props) =>
      FocusScope.withExternalFocusNode(key: props['key'],
        child: props['child'],
        focusScopeNode: props['focusScopeNode'],
        autofocus: props['autofocus'] ?? false,
        onFocusChange: props['onFocusChange'],),
  'FocusScope.of': (props) => FocusScope.of(props['pa'][0],),
  'ExcludeFocus': (props) => ExcludeFocus(key: props['key'],
    excluding: props['excluding'] ?? true,
    child: props['child'],),
  'FadeInImage': (props) => FadeInImage(key: props['key'],
  ...
  'FadeInImage.memoryNetwork': (props) =>
      FadeInImage.memoryNetwork(key: props['key'],
        placeholder: props['placeholder'],
        placeholderErrorBuilder: props['placeholderErrorBuilder'],
        image: props['image'],
        imageErrorBuilder: props['imageErrorBuilder'],
  ...
  'FadeInImage.assetNetwork': (props) =>
      FadeInImage.assetNetwork(key: props['key'],
        placeholder: props['placeholder'],
        placeholderErrorBuilder: props['placeholderErrorBuilder'],
        image: props['image'],
        imageErrorBuilder: props['imageErrorBuilder'],
        ...
        imageCacheWidth: props['imageCacheWidth'],
        imageCacheHeight: props['imageCacheHeight'],),
  'OverflowBar': (props) => OverflowBar(key: props['key'],
  ...
  'AnimatedList': (props) => AnimatedList(key: props['key'],
    itemBuilder: props['itemBuilder'],
  ...
  'SliverAnimatedList': (props) => SliverAnimatedList(key: props['key'],
    itemBuilder: props['itemBuilder'],
    findChildIndexCallback: props['findChildIndexCallback'],
    initialItemCount: props['initialItemCount'] ?? 0,),
  ...
  'RestorationScope': (props) => RestorationScope(key: props['key'],
    restorationId: props['restorationId'],
    child: props['child'],),
  ...
  'RootRestorationScope': (props) => RootRestorationScope(key: props['key'],
    restorationId: props['restorationId'],
    child: props['child'],),
  ...
  'SemanticsDebugger': (props) => SemanticsDebugger(key: props['key'],
    child: props['child'],
    labelStyle: props['labelStyle'] ?? const TextStyle(
  ...
  'Viewport': (props) => Viewport(key: props['key'],
  ...
  'ShrinkWrappingViewport': (props) => ShrinkWrappingViewport(key: props['key'],
    axisDirection: props['axisDirection'] ?? AxisDirection.down,
    crossAxisDirection: props['crossAxisDirection'],
    offset: props['offset'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,
  ...
  'Hero': (props) => Hero(key: props['key'],
    ...
    child: props['child'],),
  'HeroMode': (props) => HeroMode(key: props['key'],
    child: props['child'],
  ...
  'StretchingOverscrollIndicator': (props) => StretchingOverscrollIndicator(
    ...
    notificationPredicate: props['notificationPredicate'] ??
        defaultScrollNotificationPredicate,
    child: props['child'],),
  'Draggable': (props) => Draggable(key: props['key'],
    child: props['child'],
  ...
  'LongPressDraggable': (props) => LongPressDraggable(key: props['key'],
    child: props['child'],
    feedback: props['feedback'],
    data: props['data'],
    axis: props['axis'],
  ...
  'DragTarget': (props) => DragTarget(key: props['key'],
    builder: props['builder'],
  ...
  'SharedAppData.getValue': (props) =>
      SharedAppData.getValue(props['pa'][0] as BuildContext, props['pa'][1] as BuildContext, props['pa'][2],),
  'SharedAppData.setValue': (props) =>
      SharedAppData.setValue(props['pa'][0] as BuildContext , props['pa'][1] as BuildContext, props['pa'][2],),
  ...
  'ImageFiltered': (props) => ImageFiltered(key: props['key'],
    imageFilter: props['imageFilter'],
    child: props['child'],),
  'KeyboardListener': (props) => KeyboardListener(key: props['key'],
    focusNode: props['focusNode'],
    autofocus: props['autofocus'] ?? false,
    includeSemantics: props['includeSemantics'] ?? true,
    onKeyEvent: props['onKeyEvent'],
    child: props['child'],),
  'Shortcuts': (props) => Shortcuts(key: props['key'],
    manager: props['manager'],
    shortcuts: props['shortcuts'],
    child: props['child'],
    debugLabel: props['debugLabel'],),
  'Shortcuts.of': (props) => Shortcuts.of(props['pa'][0],),
  ...
  'PageView': (props) => PageView(key: props['key'],
    ...
    scrollBehavior: props['scrollBehavior'],
    padEnds: props['padEnds'] ?? true,),
  'PageView.builder': (props) => PageView.builder(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.horizontal,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    physics: props['physics'],
    ...
    scrollBehavior: props['scrollBehavior'],
    padEnds: props['padEnds'] ?? true,),
  'PageView.custom': (props) => PageView.custom(key: props['key'],
    scrollDirection: props['scrollDirection'] ?? Axis.horizontal,
    reverse: props['reverse'] ?? false,
    controller: props['controller'],
    physics: props['physics'],
    ...
    scrollBehavior: props['scrollBehavior'],
    padEnds: props['padEnds'] ?? true,),
  'NotificationListener': (props) => NotificationListener(key: props['key'],
    child: props['child'],
  ...
  'GridPaper': (props) => GridPaper(key: props['key'],
    ...
    child: props['child'],),
  'TweenAnimationBuilder': (props) => TweenAnimationBuilder(key: props['key'],
    tween: props['tween'],
    duration: props['duration'],
    curve: props['curve'] ?? Curves.linear,
    builder: props['builder'],
  ...
  'SlideTransition': (props) => SlideTransition(key: props['key'],
    position: props['position'],
    transformHitTests: props['transformHitTests'] ?? true,
    textDirection: props['textDirection'],
    child: props['child'],),
  'ScaleTransition': (props) => ScaleTransition(key: props['key'],
    scale: props['scale'],
    alignment: props['alignment'] ?? Alignment.center,
    filterQuality: props['filterQuality'],
    child: props['child'],),
  'RotationTransition': (props) => RotationTransition(key: props['key'],
    turns: props['turns'],
    alignment: props['alignment'] ?? Alignment.center,
    filterQuality: props['filterQuality'],
    child: props['child'],),
  'SizeTransition': (props) => SizeTransition(key: props['key'],
    axis: props['axis'] ?? Axis.vertical,
    sizeFactor: props['sizeFactor'],
    axisAlignment: props['axisAlignment']?.toDouble() ?? 0.0,
    child: props['child'],),
  'FadeTransition': (props) => FadeTransition(key: props['key'],
    opacity: props['opacity'],
    alwaysIncludeSemantics: props['alwaysIncludeSemantics'] ?? false,
    child: props['child'],),
  'SliverFadeTransition': (props) => SliverFadeTransition(key: props['key'],
    opacity: props['opacity'],
    alwaysIncludeSemantics: props['alwaysIncludeSemantics'] ?? false,
    sliver: props['sliver'],),
  ...
  'RelativePositionedTransition': (props) => RelativePositionedTransition(
    ...
    size: props['size'],
    child: props['child'],),
  'DecoratedBoxTransition': (props) => DecoratedBoxTransition(key: props['key'],
    decoration: props['decoration'],
    position: props['position'] ?? DecorationPosition.background,
    child: props['child'],),
  'AlignTransition': (props) => AlignTransition(key: props['key'],
    alignment: props['alignment'],
    child: props['child'],
  ...
  'AnimatedBuilder': (props) => AnimatedBuilder(key: props['key'],
    animation: props['animation'],
    builder: props['builder'],
    child: props['child'],),
  'SliverPersistentHeader': (props) => SliverPersistentHeader(key: props['key'],
    delegate: props['delegate'],
  ...
  'Router': (props) => Router(key: props['key'],
    routeInformationProvider: props['routeInformationProvider'],
    routeInformationParser: props['routeInformationParser'],
    routerDelegate: props['routerDelegate'],
    backButtonDispatcher: props['backButtonDispatcher'],
  ...
  'Router.navigate': (props) =>
      Router.navigate(props['pa'][0], props['pa'][1],),
  'Router.neglect': (props) => Router.neglect(props['pa'][0], props['pa'][1],),
  'BackButtonListener': (props) => BackButtonListener(key: props['key'],
    child: props['child'],
  ...
  'FocusTrap': (props) => FocusTrap(focusScopeNode: props['focusScopeNode'],
    child: props['child'],
    key: props['key'],),
  'FocusTrapArea': (props) => FocusTrapArea(focusNode: props['focusNode'],
    key: props['key'],
    child: props['child'],),
  'Directionality': (props) => Directionality(key: props['key'],
    textDirection: props['textDirection'],
    child: props['child'],),
  'Directionality.of': (props) => Directionality.of(props['pa'][0],),
  'Directionality.maybeOf': (props) => Directionality.maybeOf(props['pa'][0],),
  'Opacity': (props) => Opacity(key: props['key'],
    opacity: props['opacity']?.toDouble(),
    alwaysIncludeSemantics: props['alwaysIncludeSemantics'] ?? false,
    child: props['child'],),
  'ShaderMask': (props) => ShaderMask(key: props['key'],
    shaderCallback: props['shaderCallback'],
    blendMode: props['blendMode'] ?? BlendMode.modulate,
    child: props['child'],),
  'BackdropFilter': (props) => BackdropFilter(key: props['key'],
    filter: props['filter'],
    child: props['child'],
    blendMode: props['blendMode'] ?? BlendMode.srcOver,),
  'CustomPaint': (props) => CustomPaint(key: props['key'],
    ...
    child: props['child'],),
  'ClipRect': (props) => ClipRect(key: props['key'],
    clipper: props['clipper'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,
    child: props['child'],),
  'ClipRRect': (props) => ClipRRect(key: props['key'],
    borderRadius: props['borderRadius'] ?? BorderRadius.zero,
    clipper: props['clipper'],
    clipBehavior: props['clipBehavior'] ?? Clip.antiAlias,
    child: props['child'],),
  'ClipOval': (props) => ClipOval(key: props['key'],
    clipper: props['clipper'],
    clipBehavior: props['clipBehavior'] ?? Clip.antiAlias,
    child: props['child'],),
  'ClipPath': (props) => ClipPath(key: props['key'],
    clipper: props['clipper'],
    clipBehavior: props['clipBehavior'] ?? Clip.antiAlias,
    child: props['child'],),
  'ClipPath.shape': (props) => ClipPath.shape(key: props['key'],
    shape: props['shape'],
    clipBehavior: props['clipBehavior'] ?? Clip.antiAlias,
    child: props['child'],),
  'PhysicalModel': (props) => PhysicalModel(key: props['key'],
    ...
    child: props['child'],),
  'PhysicalShape': (props) => PhysicalShape(key: props['key'],
    clipper: props['clipper'],
    clipBehavior: props['clipBehavior'] ?? Clip.none,
    elevation: props['elevation']?.toDouble() ?? 0.0,
    color: props['color'],
    shadowColor: props['shadowColor'] ?? const Color(0xFF000000),
    child: props['child'],),
  'Transform': (props) => Transform(key: props['key'],
    ...
    filterQuality: props['filterQuality'],
    child: props['child'],),
  'Transform.rotate': (props) => Transform.rotate(key: props['key'],
    ...
    filterQuality: props['filterQuality'],
    child: props['child'],),
  'Transform.translate': (props) => Transform.translate(key: props['key'],
    offset: props['offset'],
    transformHitTests: props['transformHitTests'] ?? true,
    filterQuality: props['filterQuality'],
    child: props['child'],),
  'Transform.scale': (props) => Transform.scale(key: props['key'],
  ...
  'CompositedTransformFollower': (props) => CompositedTransformFollower(
    ...
    child: props['child'],),
  'FittedBox': (props) => FittedBox(key: props['key'],
    fit: props['fit'] ?? BoxFit.contain,
    alignment: props['alignment'] ?? Alignment.center,
    clipBehavior: props['clipBehavior'] ?? Clip.none,
    child: props['child'],),
  'FractionalTranslation': (props) => FractionalTranslation(key: props['key'],
    translation: props['translation'],
    transformHitTests: props['transformHitTests'] ?? true,
    child: props['child'],),
  'RotatedBox': (props) => RotatedBox(key: props['key'],
    quarterTurns: props['quarterTurns'],
    child: props['child'],),
  'Padding': (props) => Padding(
    key: props['key'], padding: props['padding'], child: props['child'],),
  'Align': (props) => Align(key: props['key'],
    alignment: props['alignment'] ?? Alignment.center,
    widthFactor: props['widthFactor']?.toDouble(),
    heightFactor: props['heightFactor']?.toDouble(),
    child: props['child'],),
  'Center': (props) => Center(key: props['key'],
    widthFactor: props['widthFactor']?.toDouble(),
    heightFactor: props['heightFactor']?.toDouble(),
    child: props['child'],),
  ...
  'CustomMultiChildLayout': (props) => CustomMultiChildLayout(key: props['key'],
    delegate: props['delegate'],
    children: props['children'] ?? const <Widget>[],),
  'SizedBox': (props) => SizedBox(key: props['key'],
    width: props['width']?.toDouble(),
    height: props['height']?.toDouble(),
    child: props['child'],),
  ...
  'SizedBox.square': (props) => SizedBox.square(key: props['key'],
    child: props['child'],
    dimension: props['dimension']?.toDouble(),),
  'ConstrainedBox': (props) => ConstrainedBox(key: props['key'],
  ...
  'UnconstrainedBox': (props) => UnconstrainedBox(key: props['key'],
    child: props['child'],
    textDirection: props['textDirection'],
    alignment: props['alignment'] ?? Alignment.center,
    constrainedAxis: props['constrainedAxis'],
    clipBehavior: props['clipBehavior'] ?? Clip.none,),
  'FractionallySizedBox': (props) => FractionallySizedBox(key: props['key'],
    alignment: props['alignment'] ?? Alignment.center,
    widthFactor: props['widthFactor']?.toDouble(),
    heightFactor: props['heightFactor']?.toDouble(),
    child: props['child'],),
  'LimitedBox': (props) => LimitedBox(key: props['key'],
    maxWidth: props['maxWidth']?.toDouble() ?? double.infinity,
    maxHeight: props['maxHeight']?.toDouble() ?? double.infinity,
    child: props['child'],),
  'OverflowBox': (props) => OverflowBox(key: props['key'],
    alignment: props['alignment'] ?? Alignment.center,
    ...
    child: props['child'],),
  'SizedOverflowBox': (props) => SizedOverflowBox(key: props['key'],
    size: props['size'],
    alignment: props['alignment'] ?? Alignment.center,
    child: props['child'],),
  'Offstage': (props) => Offstage(key: props['key'],
    offstage: props['offstage'] ?? true,
    child: props['child'],),
  'AspectRatio': (props) => AspectRatio(key: props['key'],
    aspectRatio: props['aspectRatio']?.toDouble(),
    child: props['child'],),
  'IntrinsicWidth': (props) => IntrinsicWidth(key: props['key'],
  ...
  'Baseline': (props) => Baseline(key: props['key'],
  ...
  'ListBody': (props) => ListBody(key: props['key'],
    mainAxis: props['mainAxis'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    children: props['children'] ?? const <Widget>[],),
  'Stack': (props) => Stack(key: props['key'],
    alignment: props['alignment'] ?? AlignmentDirectional.topStart,
    textDirection: props['textDirection'],
    fit: props['fit'] ?? StackFit.loose,
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,
    children: props['children'] ?? const <Widget>[],),
  'IndexedStack': (props) => IndexedStack(key: props['key'],
    alignment: props['alignment'] ?? AlignmentDirectional.topStart,
    textDirection: props['textDirection'],
    sizing: props['sizing'] ?? StackFit.loose,
    index: props['index'] ?? 0,
    children: props['children'] ?? const <Widget>[],),
  'Positioned': (props) => Positioned(key: props['key'],
  ...
  'Positioned.fromRelativeRect': (props) => Positioned.fromRelativeRect(
    key: props['key'], rect: props['rect'], child: props['child'],),
  'Positioned.fill': (props) => Positioned.fill(key: props['key'],
    left: props['left']?.toDouble() ?? 0.0,
    top: props['top']?.toDouble() ?? 0.0,
    right: props['right']?.toDouble() ?? 0.0,
    bottom: props['bottom']?.toDouble() ?? 0.0,
    child: props['child'],),
  'Positioned.directional': (props) => Positioned.directional(key: props['key'],
    textDirection: props['textDirection'],
    ...
    height: props['height']?.toDouble(),
    child: props['child'],),
  'PositionedDirectional': (props) => PositionedDirectional(key: props['key'],
    start: props['start']?.toDouble(),
    top: props['top']?.toDouble(),
    end: props['end']?.toDouble(),
    bottom: props['bottom']?.toDouble(),
  ...
  'Row': (props) => Row(key: props['key'],
    ...
    textBaseline: props['textBaseline'],
    children: props['children'] ?? const <Widget>[],),
  'Column': (props) => Column(key: props['key'],
    mainAxisAlignment: props['mainAxisAlignment'] ?? MainAxisAlignment.start,
    mainAxisSize: props['mainAxisSize'] ?? MainAxisSize.max,
    crossAxisAlignment: props['crossAxisAlignment'] ??
        CrossAxisAlignment.center,
  ...
  'Wrap': (props) => Wrap(key: props['key'],
    ...
    clipBehavior: props['clipBehavior'] ?? Clip.none,
    children: props['children'] ?? const <Widget>[],),
  'Flow': (props) => Flow(key: props['key'],
    delegate: props['delegate'],
    children: props['children'] ?? const <Widget>[],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'Flow.unwrapped': (props) => Flow.unwrapped(key: props['key'],
    delegate: props['delegate'],
    children: props['children'] ?? const <Widget>[],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'RichText': (props) => RichText(key: props['key'],
    text: props['text'],
  ...
  'RawImage': (props) => RawImage(key: props['key'],
    image: props['image'],
  ...
  'Listener': (props) => Listener(key: props['key'],
    ...
    child: props['child'],),
  'MouseRegion': (props) => MouseRegion(key: props['key'],
  ...
  'RepaintBoundary.wrapAll': (props) =>
      RepaintBoundary.wrapAll(props['pa'][0],),
  'IgnorePointer': (props) => IgnorePointer(key: props['key'],
    ignoring: props['ignoring'] ?? true,
    ignoringSemantics: props['ignoringSemantics'],
    child: props['child'],),
  'AbsorbPointer': (props) => AbsorbPointer(key: props['key'],
    absorbing: props['absorbing'] ?? true,
    child: props['child'],
    ignoringSemantics: props['ignoringSemantics'],),
  'MetaData': (props) => MetaData(key: props['key'],
    metaData: props['metaData'],
    behavior: props['behavior'] ?? HitTestBehavior.deferToChild,
    child: props['child'],),
  'Semantics': (props) =>
      Semantics(key: props['key'],
        child: props['child'],
  ...
  'BlockSemantics': (props) => BlockSemantics(key: props['key'],
    blocking: props['blocking'] ?? true,
    child: props['child'],),
  'ExcludeSemantics': (props) => ExcludeSemantics(key: props['key'],
    excluding: props['excluding'] ?? true,
    child: props['child'],),
  ...
  'KeyedSubtree.ensureUniqueKeysForList': (props) =>
      KeyedSubtree.ensureUniqueKeysForList(
        props['pa'][0], baseIndex: props['baseIndex'] ?? 0,),
  ...
  'GestureDetector': (props) =>
      GestureDetector(key: props['key'],
        ...
        dragStartBehavior: props['dragStartBehavior'] ??
            DragStartBehavior.start,),
  'RawGestureDetector': (props) => RawGestureDetector(key: props['key'],
    child: props['child'],
    gestures: props['gestures'] ?? const <Type, GestureRecognizerFactory>{},
    behavior: props['behavior'],
    excludeFromSemantics: props['excludeFromSemantics'] ?? false,
    semantics: props['semantics'],),
  'StreamBuilder': (props) => StreamBuilder(key: props['key'],
    initialData: props['initialData'],
    stream: props['stream'],
    builder: props['builder'],),
  'FutureBuilder': (props) => FutureBuilder(key: props['key'],
    future: props['future'],
    initialData: props['initialData'],
    builder: props['builder'],),
  'ConnectionState': {
  ...
  'DefaultTextStyle': (props) => DefaultTextStyle(key: props['key'],
    style: props['style'],
    textAlign: props['textAlign'],
    softWrap: props['softWrap'] ?? true,
    overflow: props['overflow'] ?? TextOverflow.clip,
  ...
  'DefaultTextStyle.merge': (props) => DefaultTextStyle.merge(key: props['key'],
    style: props['style'],
    textAlign: props['textAlign'],
    softWrap: props['softWrap'] ?? true,
    overflow: props['overflow'] ?? TextOverflow.clip,
  ...
  'Text': (props) => Text(props['pa'][0], key: props['key'],
    style: props['style'],
    strutStyle: props['strutStyle'],
    textAlign: props['textAlign'],
    textDirection: props['textDirection'],
    ...
    textHeightBehavior: props['textHeightBehavior'],),
  'Text.rich': (props) => Text.rich(props['pa'][0], key: props['key'],
    style: props['style'],
    strutStyle: props['strutStyle'],
    textAlign: props['textAlign'],
    textDirection: props['textDirection'],
    ...
    textWidthBasis: props['textWidthBasis'],
    textHeightBehavior: props['textHeightBehavior'],),
  'ActionListener': (props) => ActionListener(key: props['key'],
    listener: props['listener'],
    action: props['action'],
    child: props['child'],),
  'Actions': (props) => Actions(key: props['key'],
    dispatcher: props['dispatcher'],
    actions: props['actions'],
    child: props['child'],),
  'Actions.handler': (props) =>
      Actions.handler(props['pa'][0], props['pa'][1] as Intent,),
  'Actions.find': (props) =>
      Actions.find(props['pa'][0], intent: props['intent'] as Intent,),
  'Actions.maybeFind': (props) =>
      Actions.maybeFind(props['pa'][0], intent: props['intent'] as Intent,),
  'Actions.of': (props) => Actions.of(props['pa'][0],),
  'Actions.invoke': (props) => Actions.invoke(props['pa'][0], props['pa'][1] as Intent,),
  'Actions.maybeInvoke': (props) =>
      Actions.maybeInvoke(props['pa'][0], props['pa'][1] as Intent,),
  ...
  'Image': (props) => Image(key: props['key'],
    image: props['image'],
    ...
    isAntiAlias: props['isAntiAlias'] ?? false,
    filterQuality: props['filterQuality'] ?? FilterQuality.low,),
  'Image.network': (props) => Image.network(props['pa'][0], key: props['key'],
    scale: props['scale']?.toDouble() ?? 1.0,
    frameBuilder: props['frameBuilder'],
    loadingBuilder: props['loadingBuilder'],
    errorBuilder: props['errorBuilder'],
  ...
  'Image.file': (props) => Image.file(props['pa'][0], key: props['key'],
    scale: props['scale']?.toDouble() ?? 1.0,
    frameBuilder: props['frameBuilder'],
    errorBuilder: props['errorBuilder'],
    semanticLabel: props['semanticLabel'],
    ...
    cacheWidth: props['cacheWidth'],
    cacheHeight: props['cacheHeight'],),
  'Image.asset': (props) => Image.asset(props['pa'][0], key: props['key'],
    bundle: props['bundle'],
    frameBuilder: props['frameBuilder'],
    errorBuilder: props['errorBuilder'],
    semanticLabel: props['semanticLabel'],
    ...
    cacheWidth: props['cacheWidth'],
    cacheHeight: props['cacheHeight'],),
  'Image.memory': (props) => Image.memory(props['pa'][0], key: props['key'],
    scale: props['scale']?.toDouble() ?? 1.0,
    frameBuilder: props['frameBuilder'],
    errorBuilder: props['errorBuilder'],
    semanticLabel: props['semanticLabel'],
  ...
  'Texture': (props) => Texture(key: props['key'],
    textureId: props['textureId'],
    freeze: props['freeze'] ?? false,
    filterQuality: props['filterQuality'] ?? FilterQuality.low,),
  'NestedScrollView': (props) => NestedScrollView(key: props['key'],
    controller: props['controller'],
    scrollDirection: props['scrollDirection'] ?? Axis.vertical,
    reverse: props['reverse'] ?? false,
    physics: props['physics'],
  ...
  'NestedScrollViewViewport': (props) => NestedScrollViewViewport(
    ...
    handle: props['handle'],
    clipBehavior: props['clipBehavior'] ?? Clip.hardEdge,),
  'NavigationToolbar': (props) => NavigationToolbar(key: props['key'],
  ...
  'ReorderableList': (props) => ReorderableList(key: props['key'],
    itemBuilder: props['itemBuilder'],
    itemCount: props['itemCount'],
  ...
  'ReorderableList.maybeOf': (props) =>
      ReorderableList.maybeOf(props['pa'][0],),
  'SliverReorderableList': (props) => SliverReorderableList(key: props['key'],
    itemBuilder: props['itemBuilder'],
    findChildIndexCallback: props['findChildIndexCallback'],
    itemCount: props['itemCount'],
    onReorder: props['onReorder'],
  ...
  'ReorderableDelayedDragStartListener': (props) =>
      ReorderableDelayedDragStartListener(key: props['key'],
        child: props['child'],
        index: props['index'],
        enabled: props['enabled'] ?? true,),
  'SliverLayoutBuilder': (props) =>
      SliverLayoutBuilder(key: props['key'], builder: props['builder'],),
  'HeroControllerScope': (props) => HeroControllerScope(key: props['key'],
    controller: props['controller'],
    child: props['child'],),
  ...
  'Navigator': (props) => Navigator(key: props['key'],
  ...
  'Navigator.pushNamed': (props) => Navigator.pushNamed(
    props['pa'][0], props['pa'][1], arguments: props['arguments'],),
  ...
  'Navigator.pushReplacementNamed': (props) => Navigator.pushReplacementNamed(
    props['pa'][0], props['pa'][1], result: props['result'],
  ...
  'Navigator.replace': (props) => Navigator.replace(
    props['pa'][0], oldRoute: props['oldRoute'],
  ...
  'Navigator.replaceRouteBelow': (props) => Navigator.replaceRouteBelow(
    props['pa'][0], anchorRoute: props['anchorRoute'],
    newRoute: props['newRoute'],),
  ...
  'Navigator.maybePop': (props) =>
      Navigator.maybePop(props['pa'][0], props['pa'][1],),
  ...
  'Navigator.of': (props) => Navigator.of(
    props['pa'][0], rootNavigator: props['rootNavigator'] ?? false,),
  ...
  'PreferredSize': (props) => PreferredSize(key: props['key'],
    child: props['child'],
    preferredSize: props['preferredSize'],),
  'ValueListenableBuilder': (props) => ValueListenableBuilder(key: props['key'],
  ...
  'MediaQuery.removeViewPadding': (props) => MediaQuery.removeViewPadding(
    ...
    removeBottom: props['removeBottom'] ?? false,
    child: props['child'],),
  'MediaQuery.fromWindow': (props) =>
      MediaQuery.fromWindow(key: props['key'], child: props['child'],),
  ...
  'MediaQuery.boldTextOverride': (props) =>
      MediaQuery.boldTextOverride(props['pa'][0],),
  'Orientation': {
  ...
  'DecoratedBox': (props) => DecoratedBox(key: props['key'],
    decoration: props['decoration'],
    position: props['position'] ?? DecorationPosition.background,
    child: props['child'],),
  'Container': (props) => Container(key: props['key'],
    alignment: props['alignment'],
    padding: props['padding'],
    color: props['color'],
    decoration: props['decoration'],
  ...
  'EditableText': (props) =>
      EditableText(key: props['key'],
        ...
        enableIMEPersonalizedLearning: props['enableIMEPersonalizedLearning'] ??
            true,),
  'Placeholder': (props) => Placeholder(key: props['key'],
    ...
    child: props['child'],),
  'Icon': (props) => Icon(props['pa'][0], key: props['key'],
  ...
  'Banner': (props) => Banner(key: props['key'],
    child: props['child'],
  ...
  'AnimatedContainer': (props) => AnimatedContainer(key: props['key'],
    alignment: props['alignment'],
    padding: props['padding'],
    color: props['color'],
    decoration: props['decoration'],
    ...
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'AnimatedPadding': (props) => AnimatedPadding(key: props['key'],
    padding: props['padding'],
    child: props['child'],
    curve: props['curve'] ?? Curves.linear,
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'AnimatedAlign': (props) => AnimatedAlign(key: props['key'],
    alignment: props['alignment'],
    child: props['child'],
    heightFactor: props['heightFactor']?.toDouble(),
    widthFactor: props['widthFactor']?.toDouble(),
    ...
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'AnimatedPositioned': (props) => AnimatedPositioned(key: props['key'],
    child: props['child'],
    left: props['left']?.toDouble(),
    top: props['top']?.toDouble(),
    right: props['right']?.toDouble(),
  ...
  'AnimatedPositionedDirectional': (props) => AnimatedPositionedDirectional(
    ...
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'AnimatedScale': (props) => AnimatedScale(key: props['key'],
    child: props['child'],
    scale: props['scale']?.toDouble(),
    alignment: props['alignment'] ?? Alignment.center,
    filterQuality: props['filterQuality'],
    ...
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'AnimatedRotation': (props) => AnimatedRotation(key: props['key'],
    child: props['child'],
    ...
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'AnimatedSlide': (props) => AnimatedSlide(key: props['key'],
    child: props['child'],
    offset: props['offset'],
    curve: props['curve'] ?? Curves.linear,
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'AnimatedOpacity': (props) => AnimatedOpacity(key: props['key'],
    child: props['child'],
    opacity: props['opacity']?.toDouble(),
    curve: props['curve'] ?? Curves.linear,
    duration: props['duration'],
    onEnd: props['onEnd'],
    alwaysIncludeSemantics: props['alwaysIncludeSemantics'] ?? false,),
  'SliverAnimatedOpacity': (props) => SliverAnimatedOpacity(key: props['key'],
    sliver: props['sliver'],
    opacity: props['opacity']?.toDouble(),
    curve: props['curve'] ?? Curves.linear,
    duration: props['duration'],
  ...
  'AnimatedDefaultTextStyle': (props) => AnimatedDefaultTextStyle(
    ...
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'AnimatedPhysicalModel': (props) => AnimatedPhysicalModel(key: props['key'],
    child: props['child'],
    shape: props['shape'],
    clipBehavior: props['clipBehavior'] ?? Clip.none,
    borderRadius: props['borderRadius'] ?? BorderRadius.zero,
    ...
    duration: props['duration'],
    onEnd: props['onEnd'],),
  'Visibility': (props) => Visibility(key: props['key'],
    child: props['child'],
  ...
  'SliverVisibility': (props) => SliverVisibility(key: props['key'],
    sliver: props['sliver'],
    ...
    maintainSemantics: props['maintainSemantics'] ?? false,
    maintainInteractivity: props['maintainInteractivity'] ?? false,),
  'DualTransitionBuilder': (props) => DualTransitionBuilder(key: props['key'],
    animation: props['animation'],
    forwardBuilder: props['forwardBuilder'],
    reverseBuilder: props['reverseBuilder'],
    child: props['child'],),
  'Table': (props) => Table(key: props['key'],
    ...
    textBaseline: props['textBaseline'],),
  'TableCell': (props) => TableCell(key: props['key'],
  ...
  'SliverPrototypeExtentList': (props) => SliverPrototypeExtentList(
    ...
    delegate: props['delegate'],
    prototypeItem: props['prototypeItem'],),
  'AnimatedSwitcher': (props) => AnimatedSwitcher(key: props['key'],
    child: props['child'],
    duration: props['duration'],
    reverseDuration: props['reverseDuration'],
  ...
  'Title': (props) => Title(key: props['key'],
    title: props['title'] ?? '',
    color: props['color'],
    child: props['child'],),
  'ColorFiltered': (props) => ColorFiltered(colorFilter: props['colorFilter'],
    child: props['child'],
    key: props['key'],),
  ...
  'FocusTraversalGroup': (props) => FocusTraversalGroup(key: props['key'],
    policy: props['policy'],
    descendantsAreFocusable: props['descendantsAreFocusable'] ?? true,
    descendantsAreTraversable: props['descendantsAreTraversable'] ?? true,
    child: props['child'],),
  ...
  'ExcludeFocusTraversal': (props) => ExcludeFocusTraversal(key: props['key'],
    excluding: props['excluding'] ?? true,
    child: props['child'],),
  'TraversalDirection': {
  ...
  'Scrollable': (props) => Scrollable(key: props['key'],
    axisDirection: props['axisDirection'] ?? AxisDirection.down,
    controller: props['controller'],
    physics: props['physics'],
  ...
  'Scrollable.ensureVisible': (props) => Scrollable.ensureVisible(
    props['pa'][0], alignment: props['alignment']?.toDouble() ?? 0.0,
  ...
  'ImageIcon': (props) => ImageIcon(props['pa'][0], key: props['key'],
    size: props['size']?.toDouble(),
    color: props['color'],
    semanticLabel: props['semanticLabel'],),
