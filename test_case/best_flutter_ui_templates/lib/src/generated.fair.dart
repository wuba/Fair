...
import 'package:best_flutter_ui_templates/best_ui_page.dart';
...
class AppGeneratedModule extends GeneratedModule {
  ...
  Map<String, dynamic> components() {
    return {
      ...
      'MealsListData': {
        'icon1': MealsListData.icon1,
        'icon2': MealsListData.icon2,
        'icon3': MealsListData.icon3,
        'icon4': MealsListData.icon4,
        'tabIconsList': MealsListData.tabIconsList,
      },
      'MealsListData.getList': (props) => MealsListData.getList(),
      'FitnessAppTheme': {
      ...
      'MealsView': (props) => MealsView(
            key: props['key'],
            mealsListData: props['mealsListData'],
          ),
